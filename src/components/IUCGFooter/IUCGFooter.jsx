...
export default function IUCGFooter(){
    ...
    <div className="container">
        ...
        <div className="col-sm-3">
            ...
            <div className="textwidget">
                <p>
                <a href="https://umass.account.box.com/login">
                    <noscript>
                    &lt;img class="alignnone wp-image-2906 size-full"
                    src="https://www.isenbergconsulting.org/wp-content/uploads/2018/10/user.png"
                    alt="" width="24" height="24" /&gt;
                    </noscript>
                    <img
                    className="lazy alignnone wp-image-2906 size-full entered loaded"
                    src="https://www.isenbergconsulting.org/wp-content/uploads/2018/10/user.png"
                    data-src="https://www.isenbergconsulting.org/wp-content/uploads/2018/10/user.png"
                    alt=""
                    width={24}
                    height={24}
